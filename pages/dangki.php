...
<form action="#" method="POST">
    ...
    <select name="ward" id="ward" disabled>
        <option value="" selected disabled>Chọn xã/phường</option>
            ...
            <div class="links">
                <a href="./index.php?page=dangnhap"><p>← Quay lại đăng nhập</p></a>
            </div>
        </div>
    </div>
</form>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    xhrProvince.open('GET', './pages/get_locations.php', true);
    xhrProvince.send();
    ...
    provinceSelect.addEventListener('change', function (event) {
        ...
        xhrDistrict.open('GET', './pages/get_locations.php?province_id=' + provinceId, true);
        xhrDistrict.send();
    });
    ...
    districtSelect.addEventListener('change', function () {
        ...
        xhr.open('GET', 'pages/get_locations.php?district_id=' + districtId, true);
        xhr.send();
    });
